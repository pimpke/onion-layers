...
//				ORIGIN_COORDINATE_LENGHT, ORIGIN_COORDINATE_LENGHT);
		...
		for (int i = 0; i < Cartesian.points.length; i++) {
			int x = X_AXIS_FIRST_X_COORD + Cartesian.points[i].x * xLength
					- (ORIGIN_COORDINATE_LENGHT / 2);
			int y = Y_AXIS_SECOND_Y_COORD - Cartesian.points[i].y * yLength
					- (ORIGIN_COORDINATE_LENGHT / 2);
